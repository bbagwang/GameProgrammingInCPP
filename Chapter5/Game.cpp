...
void Game::CreateSpriteVerts()
{
	...
	float vertices[] = {
		//왼쪽 상단
		-0.5f,  0.5f, 0.f,		//위치 (X, Y, Z)
		0.f, 0.f,				//텍스처 좌표 (U, V)
		1.f, 0.f, 0.f, 1.f,		//버텍스 컬러 (R, G, B, A)
		//오른쪽 상단
		0.5f,  0.5f, 0.f,	  	//위치 (X, Y, Z)
		1.f, 0.f,			  	//텍스처 좌표 (U, V)
		0.f, 1.f, 0.f, 1.f,	  	//버텍스 컬러 (R, G, B, A)
		// 오른쪽 하단
		0.5f, -0.5f, 0.f,	   	//위치 (X, Y, Z)
		1.f, 1.f,			   	//텍스처 좌표 (U, V)
		0.f, 0.f, 1.f, 1.f,	   	//버텍스 컬러 (R, G, B, A)
		// 왼쪽 하단
		-0.5f, -0.5f, 0.f,	   	//위치 (X, Y, Z)
		0.f, 1.f,			   	//텍스처 좌표 (U, V)
		1.f, 1.f, 1.f, 1.f	   	//버텍스 컬러 (R, G, B, A)
	};
